...
export type IntegrationManifestModelConfig = {
  condition?: {
    slugs: string[];
  };
  jsonSchema: JsonSchema;
...
export type IntegrationManifestModel = {
  ...
  configs: IntegrationManifestModelConfig[];
};
...
export type IntegrationModelExecutePayload<
  ConnectorConfig = unknown,
  Slug = unknown,
  Config = unknown,
  Meta = unknown,
...
export type IntegrationModelExecuteResult<Meta = unknown> = {
...
export type Integration = {
  ...
  model?: {
    execute: (
      payload: IntegrationModelExecutePayload<any, any, any, any>,
    ) => Promise<IntegrationModelExecuteResult<any>>;
    count?: (
